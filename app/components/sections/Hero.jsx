...
function CodeCard() {
  ...
  return (
    ...
    >
      ...
      {/* Code body */}
      <div style={{ padding: '20px 24px', fontFamily: 'var(--font-fira)', fontSize: '13px', lineHeight: '1.9' }}>
  ...
  return (
    <section style={{
      ...
      <div style={{
        ...
        top: '200px', right: '-80px', pointerEvents: 'none',
      }} />
      <div style={{
        position: 'absolute', borderRadius: '50%',
        width: '300px', height: '300px',
        background: 'radial-gradient(circle, rgba(37,99,235,0.08) 0%, transparent 70%)',
        bottom: '100px', left: '40%', pointerEvents: 'none',
      }} />
      ...
      <div style={{ position: 'relative', zIndex: 1, flex: 1, maxWidth: '600px' }}>
        ...
        <motion.h1
          ...
          style={{ fontSize: 'clamp(40px, 5vw, 68px)', fontWeight: 700, lineHeight: 1.1, marginBottom: '16px' }}
        >
        ...
        <motion.div
          ...
          style={{ fontFamily: 'var(--font-fira)', fontSize: 'clamp(13px, 1.5vw, 18px)', marginBottom: '24px', color: '#475569' }}>
        ...
        <motion.p
          ...
          style={{ fontSize: '15px', color: '#64748b', maxWidth: '480px', lineHeight: 1.8, marginBottom: '36px' }}>
        ...
        >
          ...
          <a href="/cv.pdf" download style={{
            ...
            borderRadius: '8px', padding: '12px 28px',
            color: '#60a5fa', fontSize: '14px', fontWeight: 500,
