...
const contactInfo = [
  {
    ...
    label: 'Email',
    value: 'Ishthiyaqahamed@gmail.com',
    href: 'mailto:Ishthiyaqahamed@gmail.com',
    color: '#3b82f6',
  },
  {
    icon: <Phone size={18} strokeWidth={1.5} />,
    label: 'Phone',
    value: '+94 76 051 4320',
    href: 'tel:+94760514320',
    color: '#06b6d4',
  },
  {
...
const socials = [
  {
    ...
    label: 'LinkedIn',
    handle: 'ishthiyaqahamed',
    href: 'https://linkedin.com/in/ishthiyaqahamed',
    color: '#0a66c2',
  },
  {
    icon: <FaGithub size={18} strokeWidth={1.5} />,
    label: 'GitHub',
    handle: 'ishthiyaqAhamed',
    href: 'https://github.com/ishthiyaqAhamed',
    color: '#6e40c9',
  },
  {
    icon: <Mail size={18} strokeWidth={1.5} />,
    label: 'Email',
    handle: 'Ishthiyaqahamed@gmail.com',
    href: 'mailto:Ishthiyaqahamed@gmail.com',
    color: '#3b82f6',
  },
]
  ...
  return (
    <section id="contact" style={{
      ...
      >
        ...
        <p style={{ fontSize: '16px', color: '#64748b', marginTop: '16px', maxWidth: '500px', lineHeight: 1.8 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.5fr', gap: '64px', alignItems: 'start' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
            ...
            {contactInfo.map((item, i) => (
              ...
              >
                ...
                <div>
                  ...
                  <div style={{ fontSize: '14px', color: '#94a3b8' }}>{item.value}</div>
                </div>
              </motion.div>
            ))}
          </motion.div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
              {socials.map((s, i) => (
                ...
                onMouseLeave={e => {
                  ...
                  <div>
                    <div style={{ fontSize: '12px', color: '#475569', fontFamily: 'var(--font-fira)', marginBottom: '2px' }}>{s.label}</div>
          ...
          >
            ...
            <div>
              <div style={{ fontSize: '14px', fontWeight: 500, color: '#86efac', marginBottom: '2px' }}>
                Available for Work
              </div>
        ...
        >
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
              <div>
                <label style={{ fontSize: '12px', color: '#475569', fontFamily: 'var(--font-fira)', letterSpacing: '1px', display: 'block', marginBottom: '8px' }}>
                  NAME
                </label>
                <input
            ...
            <button
              ...
              style={{
                ...
                background: loading ? 'rgba(37,99,235,0.5)' : 'linear-gradient(135deg, #2563eb, #0891b2)',
              ...
              onMouseLeave={e => {
                ...
                e.currentTarget.style.boxShadow = loading ? 'none' : '0 0 24px rgba(37,99,235,0.35)'
              }}
            >
              {loading ? (
                <>
